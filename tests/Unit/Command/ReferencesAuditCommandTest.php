...
use OCA\Humaniq\Command\ReferencesAuditCommand;
 ...
 *
 * @covers \OCA\Humaniq\Command\ReferencesAuditCommand
 */
class ReferencesAuditCommandTest extends TestCase {
	...
	public function testADryRunReportsAndWritesNothing(): void {
		$tester = $this->tester(
			[['id' => 's1', 'kvkNumber' => 'K1', 'administration' => '']],
			[['id' => 'o1', 'kvkNumber' => 'K1']]
		);
	...
	public function testAnUnambiguousMatchIsBackfilled(): void {
		$tester = $this->tester(
			[['id' => 's1', 'kvkNumber' => 'K1', 'administration' => '', 'name' => 'keep me']],
			[['id' => 'o1', 'kvkNumber' => 'K1']]
		);
	...
	public function testAnAmbiguousMatchIsRefused(): void {
		$tester = $this->tester(
			[['id' => 's1', 'kvkNumber' => 'K1', 'administration' => '']],
			[['id' => 'o1', 'kvkNumber' => 'K1'], ['id' => 'o2', 'kvkNumber' => 'K1']]
		);
	...
	public function testARowWithNoIdentityKeyIsUnmatched(): void {
		$tester = $this->tester(
			[['id' => 's1', 'kvkNumber' => null, 'administration' => '']],
			[['id' => 'o1', 'kvkNumber' => 'K1']]
		);
	...
	public function testADanglingReferenceFailsTheCommand(): void {
		$tester = $this->tester(
			[['id' => 's1', 'kvkNumber' => 'K1', 'administration' => 'gone']],
			[['id' => 'o1', 'kvkNumber' => 'K1']]
		);
	...
	public function testAnUnreadableOwnerRegisterDoesNotInventDanglingLinks(): void {
		$tester = $this->tester(
			[['id' => 's1', 'kvkNumber' => 'K1', 'administration' => 'o1']],
			[],
			true
		);
