---
capability: humaniq-i18n-form-surface
status: done
built_by: openspec/changes/archive/2026-09-06-humaniq-i18n-form-surface
---
...
**Scope**: humaniq
**OpenSpec changes**:
- [humaniq-i18n-form-surface](../../changes/archive/2026-09-06-humaniq-i18n-form-surface/) _(archived 2026-09-06)_ — every schema title, property title and `x-enum-labels` value is a catalogue key in both locales, enum values render translated while the stored value is unchanged, and the browser catalogue is generated from the server one (kind: code)
