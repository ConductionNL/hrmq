---
capability: humaniq-timesheet-approved-typed-event
status: done
built_by: openspec/changes/archive/2026-09-06-humaniq-timesheet-approved-typed-event
---

# humaniq-timesheet-approved-typed-event Specification

**Status**: done
**Scope**: humaniq
**OpenSpec changes**:
- [humaniq-timesheet-approved-typed-event](../../changes/archive/2026-09-06-humaniq-timesheet-approved-typed-event/) _(archived 2026-09-06)_ — the approved-timesheet CloudEvent gains an ADR-041 typed `IEventDispatcher` companion so a sibling app with no HTTP receiver can consume it, dispatched additively alongside the unchanged webhook (kind: code)
